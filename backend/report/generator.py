...
def generate_html(data: dict) -> str:
    ...
    html = (
        ...
        '<title>DealLens Report — ' + address + '</title>'
        '<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"/>'
        '<style>' + CSS + '</style>'
        '</head><body>'

        '<div class="topbar">'
        '<a href="/" class="logo"><div class="logo-dot">🔍</div>DealLens.ai' + pro_badge + '</a>'
        ...
        'DealLens.ai is not a licensed broker, appraiser, or attorney. This report does not constitute investment advice. '
